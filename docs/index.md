...
VINE turns raw vineyard data — LoRaWAN sensor streams and multispectral drone
imagery — into actionable predictions for **Iron Horse Vineyards** (Sebastopol,
CA), a working vineyard serving as a living laboratory for CENIC, UC San Diego,
and partners.

## What this subproject builds

Three interconnected ML model tracks, one shared data pipeline, deployed as
inference services on NRP Kubernetes:

| Track | Deliverable | Question it answers |
|-------|-------------|---------------------|
| 💧 **Irrigation** | D2 | When will soil moisture drop too low — when should we irrigate? |
...
operators actually use, and publishes open models + pipelines for the broader
...
| Timeline | 350 hours, 13 weeks (May 25 – Aug 24, 2026) |

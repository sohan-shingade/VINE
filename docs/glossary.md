...
| Term | Meaning |
|------|---------|
| **VINE** | Vineyard Intelligence Network & Environment, the name of this project. |
| **NRP / Nautilus** | National Research Platform; its Kubernetes cluster (Nautilus) at SDSC. All compute runs here. |
| **Iron Horse** | Iron Horse Vineyards, Sebastopol CA. The demonstration site and living lab. |
...
| **GDD** | Growing Degree-Days: cumulative heat units that drive crop development, and a harvest-timing feature. |
...
| **Walk-forward validation** | Time-series eval that trains on the past and validates on the future, with no random shuffling. |
